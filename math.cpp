...
float gem::dot(const gem::vec2& vector1, const gem::vec2& vector2) {	//a1 * b1 + a2 * b2
	return vector1.x * vector2.x + vector1.y * vector2.y; 
}

float gem::dot(const gem::vec3& vector1, const gem::vec3& vector2) {	//a1 * b1 + a2 * b2 + a3 * b3
	return vector1.x * vector2.x + vector1.y * vector2.y + vector1.z * vector2.z; 
}

gem::vec4 gem::cross(const gem::mat4& matrix, const gem::vec4& vector) {	//4X4 * 4X1 = 4*1
...
gem::mat4 gem::cross(const gem::mat4& matrix1, const gem::mat4& matrix2) {	//4X4 * 4X4 = 4X4
	gem::mat4 result;
